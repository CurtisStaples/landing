  ...
  <div class="relative">
    <div class="bg-background border-gradient rounded-xl p-4">
      <div class="aspect-w-16 aspect-h-9 rounded-lg relative overflow-hidden border border-dashed border-gray-950/10 dark:border-white/10">
       <iframe width="560" height="315" src="https://www.youtube.com/embed/6_q_LHq85Cs?si=LbL7_WbLJj4xXjCU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </div>
</template>
